    ...
    <section >
      <div class="flex min-w-screen items-center text-center pt-20 lg:pt-40 lg:pr-5  dark:bg-gray-900 ">
        <div  id = "Contact" class="mx-auto w-full max-w-max ">
          ...
          <section class = " mx-12 pb-4 px-5 mb-4 3xl:p-10 text-sm shadow-md rounded-lg dark:shadow-grey lg:mt-10 lg:mx-20  lg:mb-6 lg:p-5 xl:mx-20 xl:mb-8 text-black dark:text-black dark:bg-white dark:shadow-white flex items-center justify-center">
