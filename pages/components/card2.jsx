...
export default function Card_temp2() {
  return (
    <div className="3xl:w-[60rem] md:w-[50rem] md:h-[23rem] sm:h-[18rem] w-[20em] h-[15.5rem]  p-4 rounded-2xl md:m-5 bg-white dark:bg-slate-800 shadow-lg dark:shadow-slate-700 flex flex-col ease-linear duration-300 md:flex-row-reverse">
    ...
    <div className=" h-full w-full rounded-2xl md:pr-5 md:mt-10 lg:pr-20 ">
      ...
      <div className=" pt-2 flex flex-row justify-left flex-wrap md:pt-4 lg:pr-20">
        ...
        >
          <button className="md:pr-2 hover:-translate-y-0.5 transform transistion hover:animate-pulse m-auto xs:mt-4 bg-[#08e2ff] text-right shadow-md shadow-[#dbdbdb8a]  p-2 rounded-xl flex flex-row justify-center items-center hover:bg-[#1caac4] ease-linear duration-300">
            <div
              style={{
                display: "flex",
                alignItems: "center",
