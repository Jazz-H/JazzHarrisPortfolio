      ...
      <div className="dp-bento" ref={bentoRef}>
        ...
        <div className="dp-bento-right">
          <div className="dp-bento-tile dp-bento-bio">
            ...
            <p className="dp-p">Today I'm a Business Analyst at Coca-Cola Consolidated, leading requirements definition for a cross-functional Agile scrum team of 10+ and mentoring newer analysts on process mapping and AI tooling. Outside of work I build websites, custom software, and tools for businesses and entrepreneurs, most recently Valora, a personal finance platform. When I'm not behind a screen: traveling, Legos, and anything with four wheels or two.</p>
          </div>
