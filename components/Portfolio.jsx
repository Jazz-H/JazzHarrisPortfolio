...
const PROJECTS = [
  ...
  {
    cat: "Branding & Design", kind: "UI/UX", title: "LOFT Living — UX Redesign", noLink: true,
    ...
    tags: ["UX Research", "UI Design", "Competitive Analysis"],
